 ...
 * 発注者テスト
 */
class OrdererTest extends Login
{
    ...
    public function test_create_name_required(): void
    {
        ...
        $this->response
            ->assertUnprocessable()
            ->assertJson([
                'message' => __('validation.required', ['attribute' => OrdererTest::ATTRIBUTES['name']]),
            ])
            ->assertInvalid([
                'name' => __('validation.required', ['attribute' => OrdererTest::ATTRIBUTES['name']]),
            ]);
    }
    ...
    public function test_create_name_max(): void
    {
        ...
        $this->response
            ->assertUnprocessable()
            ->assertJson([
                'message' => __('validation.max.string', ['attribute' => OrdererTest::ATTRIBUTES['name'], 'max' => 128]),
            ])
            ->assertInvalid([
                'name' => __('validation.max.string', ['attribute' => OrdererTest::ATTRIBUTES['name'], 'max' => 128]),
            ]);
    }
    ...
    public function test_create_sort_order_required(): void
    {
        ...
        $this->response
            ->assertUnprocessable()
            ->assertJson([
                'message' => __('validation.required', ['attribute' => OrdererTest::ATTRIBUTES['sort_order']]),
            ])
            ->assertInvalid([
                'sort_order' => __('validation.required', ['attribute' => OrdererTest::ATTRIBUTES['sort_order']]),
            ]);
    }
    ...
    public function test_create_sort_order_integer(): void
    {
        ...
        $this->response
            ->assertUnprocessable()
            ->assertJson([
                'message' => __('validation.integer', ['attribute' => OrdererTest::ATTRIBUTES['sort_order']]),
            ])
            ->assertInvalid([
                'sort_order' => __('validation.integer', ['attribute' => OrdererTest::ATTRIBUTES['sort_order']]),
            ]);
    }
    ...
    public function test_create_sort_order_min(): void
    {
        ...
        $this->response
            ->assertUnprocessable()
            ->assertJson([
                'message' => __('validation.min.numeric', ['attribute' => OrdererTest::ATTRIBUTES['sort_order'], 'min' => 0]),
            ])
            ->assertInvalid([
                'sort_order' => __('validation.min.numeric', ['attribute' => OrdererTest::ATTRIBUTES['sort_order'], 'min' => 0]),
            ]);
    }
    ...
    public function test_create_sort_order_max(): void
    {
        ...
        $this->response
            ->assertUnprocessable()
            ->assertJson([
                'message' => __('validation.max.numeric', ['attribute' => OrdererTest::ATTRIBUTES['sort_order'], 'max' => 255]),
            ])
            ->assertInvalid([
                'sort_order' => __('validation.max.numeric', ['attribute' => OrdererTest::ATTRIBUTES['sort_order'], 'max' => 255]),
            ]);
    }
    ...
    public function test_create_name_unique(): void
    {
        ...
        $this->response
            ->assertUnprocessable()
            ->assertJson([
                'message' => __('validation.unique', ['attribute' => OrdererTest::ATTRIBUTES['name']]),
            ])
            ->assertInvalid([
                'name' => __('validation.unique', ['attribute' => OrdererTest::ATTRIBUTES['name']]),
            ]);
    }
